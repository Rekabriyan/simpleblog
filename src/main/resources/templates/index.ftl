...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
		<div class="container">
			...
			<button class="btn btn-secondary" id="create_btn" data-toggle="modal"
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-8" id="posts">
				...
				<h1 class="my-4">
					Donghun's Blog <small>welcome!</small>
				</h1>
	...
	<footer class="py-5 bg-dark">
		<div class="container">
			<p class="m-0 text-center text-white">Copyright &copy; Donghun
				Lee 2018</p>
		</div>
	</footer>
